!(function (t, e) {
  ...
  return (function (t) {
            ...
            try {
              ...
              if (t && ('object' == typeof t || 'function' == typeof t)) {
                ...
                if ('function' == typeof e)
                  return void f(i(e, t), i(s, this), i(a, this));
              }
    ...
    function (t, e) {
      function n() {
        (c = !1), s.length ? (u = s.concat(u)) : (f = -1), u.length && i();
      }
      function i() {
        if (!c) {
          var t = setTimeout(n);
      ...
      (a.nextTick = function (t) {
        ...
        u.push(new r(t, e)), 1 !== u.length || c || setTimeout(i, 0);
      }),
    ...
    function (t, e) {
      var n = {
        states: [],
        add: function (t, e) {
          e || (e = void 0), this.states.push({ url: t, namespace: e });
        },
    ...
    function (t, e) {
      var n = {
        parseResponse: function (t) {
          ...
          return n && (document.title = n.innerText), this.getContainer(e);
        },
